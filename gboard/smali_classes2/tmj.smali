...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ltmj;->d:Ljava/lang/RuntimeException;

    return-void
.end method

.method public constructor <init>(Ltmk;Ltbs;Ljava/lang/ref/ReferenceQueue;Ljava/util/concurrent/ConcurrentMap;)V
    .locals 2
    ...
    iput-object p1, p0, Ltmj;->a:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p1, Ljava/lang/ref/SoftReference;

    sget-boolean v0, Ltmj;->c:Z
    ...
    .line 7
    :cond_0
    sget-object v0, Ltmj;->d:Ljava/lang/RuntimeException;

    .line 4
    :goto_0
    invoke-direct {p1, v0}, Ljava/lang/ref/SoftReference;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, Ltmj;->h:Ljava/lang/ref/Reference;
    ...
    iput-object p1, p0, Ltmj;->g:Ljava/lang/String;

    iput-object p3, p0, Ltmj;->e:Ljava/lang/ref/ReferenceQueue;

    iput-object p4, p0, Ltmj;->f:Ljava/util/concurrent/ConcurrentMap;

    .line 6
    invoke-interface {p4, p0, p0}, Ljava/util/concurrent/ConcurrentMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 7
    invoke-static {p3}, Ltmj;->a(Ljava/lang/ref/ReferenceQueue;)V
...
.method static a(Ljava/lang/ref/ReferenceQueue;)V
    ...
    iget-object v1, v0, Ltmj;->h:Ljava/lang/ref/Reference;
    ...
    .line 3
    invoke-direct {v0}, Ltmj;->b()V

    iget-object v2, v0, Ltmj;->a:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    .line 5
    sget-object v3, Ltmk;->b:Ljava/util/logging/Logger;
    ...
    sget-object v2, Ltmk;->b:Ljava/util/logging/Logger;
    ...
    iget-object v0, v0, Ltmj;->g:Ljava/lang/String;
    ...
    sget-object v0, Ltmk;->b:Ljava/util/logging/Logger;
...
.method private final b()V
    ...
    iget-object v0, p0, Ltmj;->f:Ljava/util/concurrent/ConcurrentMap;

    .line 2
    invoke-interface {v0, p0}, Ljava/util/concurrent/ConcurrentMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v0, p0, Ltmj;->h:Ljava/lang/ref/Reference;
...
.method public final clear()V
    ...
    .line 1
    invoke-direct {p0}, Ltmj;->b()V

    iget-object v0, p0, Ltmj;->e:Ljava/lang/ref/ReferenceQueue;

    .line 2
    invoke-static {v0}, Ltmj;->a(Ljava/lang/ref/ReferenceQueue;)V
