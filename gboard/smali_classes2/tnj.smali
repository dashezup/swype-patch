...
.field private static final d:Luir;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ltnj;->a:Ljava/util/logging/Logger;

    new-instance v0, Luir;

    invoke-direct {v0}, Luir;-><init>()V

    sput-object v0, Ltnj;->d:Luir;

    new-instance v0, Ltni;

    invoke-direct {v0}, Ltni;-><init>()V

    sput-object v0, Ltnj;->c:Lqgc;
...
.method public constructor <init>()V
    ...
    sget-object v0, Ltnj;->c:Lqgc;

    sget-object v1, Ltnj;->d:Luir;
    ...
    :goto_0
    sget-object v2, Ltnj;->a:Ljava/util/logging/Logger;
    ...
    iput-object v2, p0, Ltnj;->b:Ljava/net/InetSocketAddress;
    ...
    iput-object v0, p0, Ltnj;->b:Ljava/net/InetSocketAddress;

    return-void
.end method

.method public static final a(Ljava/net/InetSocketAddress;)Ltda;
    .locals 13
    ...
    .line 1
    :try_start_0
    invoke-static {p0}, Ltjf;->g(Ljava/net/InetSocketAddress;)Ljava/lang/String;
    ...
    sget-object p0, Ltnj;->a:Ljava/util/logging/Logger;
    ...
    sget-object v4, Ltnj;->a:Ljava/util/logging/Logger;
    ...
    .line 14
    invoke-static {v1}, Ltjf;->g(Ljava/net/InetSocketAddress;)Ljava/lang/String;
    ...
    .line 17
    invoke-static {v2, v3, v4}, Luir;->c(Ljava/lang/String;Ljava/net/InetAddress;I)Ljava/net/PasswordAuthentication;
    ...
    .line 21
    invoke-virtual {v3, p0}, Ltal;->c(Ljava/net/InetSocketAddress;)V

    .line 22
    invoke-virtual {v3, v1}, Ltal;->b(Ljava/net/SocketAddress;)V

    if-nez v2, :cond_4

    .line 23
    invoke-virtual {v3}, Ltal;->a()Ltam;
    ...
    iput-object p0, v3, Ltal;->a:Ljava/lang/String;
    ...
    :goto_0
    iput-object v0, v3, Ltal;->b:Ljava/lang/String;
    ...
    .line 2
    sget-object v1, Ltnj;->a:Ljava/util/logging/Logger;
    ...
    .line 25
    sget-object v7, Ltnj;->a:Ljava/util/logging/Logger;
