...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View$OnClickListener;)V
    ...
    .line 1
    invoke-direct {v0, p0}, Lkqw;-><init>(Lkqx;)V

    iput-object v0, p0, Lkqx;->e:Landroid/view/View$OnClickListener;

    iput-object p1, p0, Lkqx;->d:Landroid/content/Context;

    iput-object p2, p0, Lkqx;->b:Landroid/view/View$OnClickListener;
...
.method public final a()V
    ...
    iget-object v0, p0, Lkqx;->c:Landroid/widget/PopupWindow;
...
.method public final b(Landroid/view/View;Landroid/view/View;[Ljava/lang/String;Landroid/widget/PopupWindow$OnDismissListener;FIIIILkse;)V
    .locals 15
    ...
    .line 2
    new-instance v14, Lkqv;

    iget-object v2, v0, Lkqx;->d:Landroid/content/Context;

    iget-object v4, v0, Lkqx;->e:Landroid/view/View$OnClickListener;
    ...
    invoke-direct/range {v1 .. v9}, Lkqv;-><init>(Landroid/content/Context;[Ljava/lang/String;Landroid/view/View$OnClickListener;IILandroid/view/View;FLkse;)V
    ...
    .line 6
    invoke-virtual {v14}, Lkqv;->a()I

    move-result v5

    iget-object v6, v0, Lkqx;->d:Landroid/content/Context;
    ...
    iput-object v6, v0, Lkqx;->c:Landroid/widget/PopupWindow;

    .line 15
    invoke-virtual {v14}, Lkqv;->isEnabled()Z

    move-result v8

    invoke-virtual {v6, v8}, Landroid/widget/PopupWindow;->setTouchable(Z)V

    iget-object v6, v0, Lkqx;->c:Landroid/widget/PopupWindow;
    ...
    .line 17
    invoke-virtual {v6, v8}, Landroid/widget/PopupWindow;->setSoftInputMode(I)V

    iget-object v6, v0, Lkqx;->c:Landroid/widget/PopupWindow;

    iget-object v8, v0, Lkqx;->d:Landroid/content/Context;
    ...
    iget-object v5, v0, Lkqx;->c:Landroid/widget/PopupWindow;
    ...
    iget-object v2, v0, Lkqx;->c:Landroid/widget/PopupWindow;
    ...
    :cond_2
    iget-object v1, v0, Lkqx;->c:Landroid/widget/PopupWindow;
