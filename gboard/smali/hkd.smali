...
.method public constructor <init>(ILjava/lang/String;Ljava/io/File;Ljava/io/File;Z)V
    ...
    iput-object p3, p0, Lhkd;->b:Ljava/io/File;
    ...
    iput-object p1, p0, Lhkd;->g:Ljava/io/File;
    ...
    iput-object v0, p0, Lhkd;->d:Ljava/io/File;
    ...
    iput-object p3, p0, Lhkd;->e:Ljava/io/File;
    ...
    iput-object p2, p0, Lhkd;->h:Ljava/io/File;
    ...
    iput-object p4, p0, Lhkd;->c:Ljava/io/File;
    ...
    iput-boolean p5, p0, Lhkd;->i:Z

    if-eqz p5, :cond_0

    .line 7
    sget-object p2, Lhnp;->O:Lhnp;

    invoke-static {p2}, Lhkd;->b(Lhnp;)V
    ...
    .line 11
    invoke-virtual {p2, p3}, Lmnu;->d(Ljava/io/File;)Z

    .line 12
    invoke-virtual {p2, p1, p4}, Lmnu;->j(Ljava/io/File;Ljava/io/File;)Z

    :cond_0
    return-void
.end method

.method private static b(Lhnp;)V
    .locals 1
    ...
    .line 1
    invoke-virtual {v0, p0}, Lhnq;->c(Lhnp;)V
...
.method public final a()Ljava/io/File;
    ...
    iget-boolean v0, p0, Lhkd;->i:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lhkd;->c:Ljava/io/File;

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lhkd;->g:Ljava/io/File;
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v0, p0, Lhkd;->a:Ljava/lang/String;
