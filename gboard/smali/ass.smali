...
.method public final bridge synthetic a(Lats;F)Ljava/lang/Object;
    ...
    invoke-virtual/range {p1 .. p1}, Lats;->r()I
    ...
    :cond_0
    invoke-virtual/range {p1 .. p1}, Lats;->d()V
    ...
    invoke-virtual/range {p1 .. p1}, Lats;->e()V
    ...
    invoke-direct {v6, v4, v2}, Lari;-><init>([F[I)V
    ...
    :cond_b
    :goto_5
    invoke-virtual {v6}, Lari;->a()I

    move-result v1

    if-ge v5, v1, :cond_e

    iget-object v1, v6, Lari;->b:[I

    aget v1, v1, v5

    iget-object v2, v6, Lari;->a:[F
    ...
    invoke-static/range {v19 .. v24}, Laty;->d(DDD)D
