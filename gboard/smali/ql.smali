...
# direct methods
.method public constructor <init>(Lue;Ljava/util/ArrayList;)V
    .locals 0

    iput-object p1, p0, Lql;->b:Lue;

    iput-object p2, p0, Lql;->a:Ljava/util/ArrayList;
...
.method public final run()V
    ...
    iget-object v4, p0, Lql;->b:Lue;

    .line 2
    iget-object v5, v3, Lqs;->a:Lts;
    ...
    .line 14
    :cond_0
    iget-object v5, v5, Lts;->a:Landroid/view/View;

    .line 3
    :goto_1
    iget-object v7, v3, Lqs;->b:Lts;

    if-eqz v7, :cond_1

    iget-object v6, v7, Lts;->a:Landroid/view/View;
    ...
    iget-object v11, v4, Lue;->j:Ljava/util/ArrayList;

    .line 5
    iget-object v12, v3, Lqs;->a:Lts;
    ...
    invoke-direct {v12, v4, v3, v10, v5}, Lqq;-><init>(Lue;Lqs;Landroid/view/ViewPropertyAnimator;Landroid/view/View;)V
    ...
    iget-object v10, v4, Lue;->j:Ljava/util/ArrayList;

    .line 11
    iget-object v11, v3, Lqs;->b:Lts;
    ...
    invoke-direct {v8, v4, v3, v5, v6}, Lqr;-><init>(Lue;Lqs;Landroid/view/ViewPropertyAnimator;Landroid/view/View;)V
    ...
    iget-object v0, p0, Lql;->b:Lue;

    iget-object v0, v0, Lue;->f:Ljava/util/ArrayList;

    iget-object v1, p0, Lql;->a:Ljava/util/ArrayList;
