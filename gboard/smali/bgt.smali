...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lbgt;->b:Landroid/graphics/Paint;
    ...
    .line 4
    :goto_0
    sput-object v0, Lbgt;->a:Ljava/util/concurrent/locks/Lock;
    ...
    sput-object v0, Lbgt;->c:Landroid/graphics/Paint;
...
.method public static a(Lbar;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 6
    ...
    .line 10
    invoke-static {p1}, Lbgt;->g(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;

    move-result-object v1

    invoke-interface {p0, p2, p3, v1}, Lbar;->c(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;

    move-result-object p0

    .line 11
    invoke-static {p1, p0}, Lbgt;->d(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V

    .line 12
    invoke-static {p1, p0, v0}, Lbgt;->h(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V

    return-object p0
.end method

.method public static b(Lbar;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 2
    ...
    .line 11
    invoke-interface {p0, p3, v0, v1}, Lbar;->c(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    .line 15
    invoke-static {p1, p0, p3}, Lbgt;->h(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V

    return-object p0
.end method

.method public static c(Lbar;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 1
    ...
    .line 2
    :cond_0
    invoke-static {p0, p1, p2, p3}, Lbgt;->b(Lbar;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
...
.method public static h(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
    ...
    sget-object v0, Lbgt;->a:Ljava/util/concurrent/locks/Lock;
    ...
    sget-object p1, Lbgt;->b:Landroid/graphics/Paint;
