...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 6
    invoke-direct {v1, p0}, Lxt;-><init>(Landroidx/cardview/widget/CardView;)V

    iput-object v1, p0, Landroidx/cardview/widget/CardView;->f:Lxt;

    .line 7
    sget-object v2, Lxs;->a:[I
    ...
    .line 31
    invoke-direct {v0, p1, p3}, Lxu;-><init>(Landroid/content/res/ColorStateList;F)V

    iput-object v0, v1, Lxt;->a:Landroid/graphics/drawable/Drawable;

    iget-object p1, v1, Lxt;->b:Landroidx/cardview/widget/CardView;
    ...
    iget-object p1, v1, Lxt;->a:Landroid/graphics/drawable/Drawable;
    ...
    iget-boolean v2, p1, Lxu;->c:Z

    if-ne v2, p3, :cond_3

    iget-boolean v2, p1, Lxu;->d:Z
    ...
    iput-boolean p3, p1, Lxu;->c:Z

    iput-boolean v0, p1, Lxu;->d:Z

    const/4 p2, 0x0

    .line 36
    invoke-virtual {p1, p2}, Lxu;->a(Landroid/graphics/Rect;)V

    invoke-virtual {p1}, Lxu;->invalidateSelf()V
    ...
    .line 43
    invoke-virtual {v1, v3, v3, v3, v3}, Lxt;->c(IIII)V
    ...
    invoke-static {p2, p1, p3}, Lxv;->b(FFZ)F
    ...
    invoke-static {p2, p1, v0}, Lxv;->a(FFZ)F
    ...
    .line 42
    invoke-virtual {v1, p3, p1, p3, p1}, Lxt;->c(IIII)V
