...
.method public final a(Landroid/view/View;Lif;)Lif;
    ...
    .line 1
    invoke-virtual/range {p2 .. p2}, Lif;->d()I

    move-result v0

    move-object v1, p0

    iget-object v2, v1, Ljv;->a:Lkl;
    ...
    iget-object v4, v2, Lkl;->m:Landroid/support/v7/widget/ActionBarContextView;
    ...
    iget-object v8, v2, Lkl;->m:Landroid/support/v7/widget/ActionBarContextView;
    ...
    iget-object v8, v2, Lkl;->G:Landroid/graphics/Rect;
    ...
    iput-object v8, v2, Lkl;->G:Landroid/graphics/Rect;
    ...
    iput-object v8, v2, Lkl;->H:Landroid/graphics/Rect;

    :cond_0
    iget-object v8, v2, Lkl;->G:Landroid/graphics/Rect;

    iget-object v9, v2, Lkl;->H:Landroid/graphics/Rect;

    .line 8
    invoke-virtual/range {p2 .. p2}, Lif;->c()I
    ...
    .line 10
    invoke-virtual/range {p2 .. p2}, Lif;->e()I

    move-result v12

    .line 11
    invoke-virtual/range {p2 .. p2}, Lif;->f()I
    ...
    iget-object v10, v2, Lkl;->s:Landroid/view/ViewGroup;

    .line 13
    sget-object v11, Lvm;->a:Ljava/lang/reflect/Method;
    ...
    iget-object v11, v2, Lkl;->s:Landroid/view/ViewGroup;

    .line 18
    invoke-static {v11}, Lho;->L(Landroid/view/View;)Lif;
    ...
    iget-object v9, v2, Lkl;->t:Landroid/view/View;

    if-nez v9, :cond_6

    new-instance v9, Landroid/view/View;

    iget-object v10, v2, Lkl;->g:Landroid/content/Context;

    .line 26
    invoke-direct {v9, v10}, Landroid/view/View;-><init>(Landroid/content/Context;)V

    iput-object v9, v2, Lkl;->t:Landroid/view/View;
    ...
    iget-object v11, v2, Lkl;->t:Landroid/view/View;
    ...
    iget-object v10, v2, Lkl;->t:Landroid/view/View;
    ...
    .line 31
    invoke-static {v9}, Lho;->F(Landroid/view/View;)I
    ...
    iget-object v11, v2, Lkl;->g:Landroid/content/Context;
    ...
    :cond_10
    :goto_a
    iget-object v2, v2, Lkl;->t:Landroid/view/View;
    ...
    .line 41
    invoke-virtual {v5, v0, v3, v2, v4}, Lif;->i(IIII)Lif;
    ...
    .line 42
    :goto_c
    invoke-static {v2, v0}, Lho;->J(Landroid/view/View;Lif;)Lif;
